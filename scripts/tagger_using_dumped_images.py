...
'''Function name : capture_video
   Description : Captures a frames from a folder path and runs through the frames to select a particular frame for tagging
   Input Parameters :
   folder_path : Path of the folder on which tagging is to be done
   Output Parameters :
...
#     path_to_save=capture_frames("frameset4")